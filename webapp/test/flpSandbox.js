						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#PurchaseRequisition-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"PurchaseRequisition-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprcreatenew",
									"url": sap.ui.require.toUrl("zprcreatenew")
								}
							}
						}
					}
